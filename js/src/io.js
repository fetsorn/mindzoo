 ...
 * @returns {String}
 */
export async function findMind(fs, mind) {
 ...
 * @returns {File}
 */
export async function fetchFile(fs, mind, filepath) {
 ...
 * @returns {String}
 */
export async function readFile(fs, mind, filepath) {
  const file = await fetchFile(fs, mind, filepath);
 ...
 */
export async function writeFile(fs, mind, filepath, content) {
  const dir = await findMind(fs, mind);
 ...
 */
export async function rimraf(fs, rimrafpath) {
  let files;
 ...
 * @param {String} lspath -
 */
export async function ls(fs, lspath) {
  let files;
